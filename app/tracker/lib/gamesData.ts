...
export const gamesLibrary: Game[] = [
  ...
  },
  {
    ...
    developer: ["FromSoftware","Activision"],
...
},
{
  ...
  developer: ["Tango Gameworks","Bethesda Game Studios"],
...
},
{
  id: "dishonored-2",
  title: "Dishonored 2",
  developer: ["Arkane Studios","Bethesda Game Studios"],
...
},
{
  id: "just-cause-4",
  title: "Just Cause 4",
  developer: ["Avalanche Studios","Square Enix"],
  genre: ["Action", "Open World", "Adventure"],
  release_year: 2018,
  rating: 7.5,
  platforms: ["PC", "PS4", "Xbox One"],
...
},
{
  ...
  developer: ["Tarsier Studios","Bandai Namco Studios"],
...
},
{
  id: "doom-eternal",
  title: "DOOM Eternal",
  developer: ["id Software","Bethesda Game Studios"],
...
},
{
  "id": "prototype",
  "title": "Prototype",
  "developer": ["Radical Entertainment","Activision"],
  "genre": ["Action", "Open World", "Adventure"],
  "release_year": 2009,
  "rating": 8.1,
  "platforms": ["PC", "PS3", "Xbox 360"],
...
}, 
{
  "id": "mad_max",
  "title": "Mad Max",
  "developer": ["Avalanche Studios","Avalanche Studios","WB Games"],
  "genre": ["Action", "Open World", "Adventure"],
  "release_year": 2015,
  "rating": 8.3,
  "platforms": ["PC", "PS4", "Xbox One"],
...
},
{
  ...
  "developer": ["Supermassive Games","Bandai Namco Studios"],
...
},
{
  ...
  developer: ["MachineGames","Bethesda Game Studios"],
...
},
{
  ...
  developer: ["Turtle Rock Studios","WB Games"],
...
},
{
  ...
  developer: ["FromSoftware","Bandai Namco Studios"],
...
},
{
  id: "fear",
  title: "F.E.A.R.",
  developer: ["Monolith Productions","WB Games"],
...
export function searchGames(query: string): Game[] {
  ...
  return gamesLibrary.filter(game => {
    // normalize developer to array
    const developers = Array.isArray(game.developer)
      ? game.developer
      : [game.developer];

    return (
      game.title.toLowerCase().includes(lowerQuery) ||
      developers.some(dev => dev.toLowerCase().includes(lowerQuery)) ||
